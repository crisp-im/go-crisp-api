...
* **📝 Implements**: [REST API Reference (V1)](https://docs.crisp.chat/references/rest-api/v1/) at revision: 02/10/2021
...
* **Website Conversation**
  ...
  * **Get Messages In Conversation (Before Variant)** [`user`, `plugin`]: `client.Website.GetMessagesInConversationBefore(websiteID string, sessionID string, timestampBefore uint) (*[]ConversationMessage, *Response, error)`
